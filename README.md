...
npm run aeat:final-evidence:verify -- --accepted <accepted.json> --rejected <rejected.json> --reconciliation <reconciliation-apply.json> --source-commit <SHA40>
